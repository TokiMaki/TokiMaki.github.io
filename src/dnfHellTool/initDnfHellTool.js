...
function createToolContext(els) {
  ...
  const constants = {
    ACTIVE_TAB_STORAGE_KEY, API_BASE, DEV_MODE_STORAGE_KEY, parseApiJsonResponse, STORAGE_NAMESPACE_KEY, STORAGE_SCOPE_LABEL, SUPPLY_SOUL_EXCLUDED_KEYS_STORAGE_KEY, SUPPLY_SOUL_USAGE_RATES_STORAGE_KEY,
