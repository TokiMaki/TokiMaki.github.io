...
class RelicCraftEquipmentBodyTest(unittest.TestCase):
    ...
    def test_calculation_constants_have_one_authoritative_source(self):
        ...
        self.assertIn("정밀 재료", frontend_source)
        self.assertNotIn("회 상당", frontend_source)
        self.assertIn("+ '회)'", frontend_source)
        ...
        self.assertIn("정밀 재료 (' + formatMaterialAmount", frontend_source)
