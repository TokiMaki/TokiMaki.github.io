...
assert.match(viewSource, /function removeActiveRelicSelectionsForPrecisionFilter\(includePrecision\)/);
assert.match(viewSource, /snapshot\.relicCraftMode === 'precision'/);
assert.match(viewSource, /const hasTargetPrecision = Number\.isFinite\(targetPrecisionPercent\)/);
assert.match(viewSource, /includePrecision\s*\? snapshot\.relicCraftMode !== 'precision' && !hasTargetPrecision/);
assert.match(viewSource, /removeActiveRelicSelectionsForPrecisionFilter\(includeRelicPrecision\)/);
