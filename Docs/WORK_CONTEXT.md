...
- 다음 작업: 버프강화 metric·recommendation adaptation 경계를 분석하되, 실제 loadout 교체·복원에도 공유되는 `getBuffLoadoutRowsForMetric`과 simulator mutation은 view에 남길 범위를 먼저 확인한다.
