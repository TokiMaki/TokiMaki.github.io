...
8. 항목 하나가 검증된 뒤 그 항목의 변경만 한 번 커밋한다.
9. 커밋 후 다음 항목으로 이동한다.
...
| 2 | TTL 캐시의 만료 데이터 및 크기 정리 누락 | P1 | 대기 | - |
| 3 | 공개 응답 캐시의 키별 Lock 무제한 증가 | P2 | 대기 | - |
| 4 | 테스트가 배포 게이트에 연결되지 않음 | P1 | 대기 | - |
| 5 | React 언마운트 후 이벤트 리스너 미정리 | P2 | 대기 | - |
